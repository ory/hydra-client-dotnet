...
{
    /// <summary>
    /// HydraOpenIDConnectContext
    /// </summary>
    [DataContract(Name = "openIDConnectContext")]
    public partial class HydraOpenIDConnectContext : IEquatable<HydraOpenIDConnectContext>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="HydraOpenIDConnectContext" /> class.
        /// </summary>
        ...
        public HydraOpenIDConnectContext(List<string> acrValues = default(List<string>), string display = default(string), Dictionary<string, Object> idTokenHintClaims = default(Dictionary<string, Object>), string loginHint = default(string), List<string> uiLocales = default(List<string>))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class HydraOpenIDConnectContext {\n");
        ...
        {
            return this.Equals(input as HydraOpenIDConnectContext);
        }

        /// <summary>
        /// Returns true if HydraOpenIDConnectContext instances are equal
        /// </summary>
        /// <param name="input">Instance of HydraOpenIDConnectContext to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(HydraOpenIDConnectContext input)
        {
            if (input == null)
            {
                return false;
